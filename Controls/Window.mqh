...
private:
   ...
   int               m_prev_x;        // Точка фиксации при нажатии
   int               m_prev_y;        // Точка фиксации при нажатии
   int               m_size_fixing_x; // Расстояние от X скролла до точки фиксации
   int               m_size_fixing_y; // Расстояние от Y скролла до точки фиксации
